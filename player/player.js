define(['butterfly/view', "main/util", "main/client", "main/parseLrc", "css!player/player"], function(View, Util, Client, lrcParser, CSS){
  ...
  return View.extend({
    ...
    download: function(){
        ...
        //var tmpArr = _this.downloadQue[_this.currentSongTitle + "--" + _this.currentSongArtist] = [];
        //var fileTransfer = tmpArr[0] = new FileTransfer();
        var fileTransfer = new FileTransfer();
        console.log(fileTransfer)
        /*fileTransfer.download(
            encodeURI(_this.currentSongSrc),
            "cdvfile://localhost/persistent/test/",
            function(entry) {
                alert("download complete: " + entry.toURL(), entry);
            },
            function(error) {
    ...
    toggleLrc: function(){
        var _this = this;
        $("#lrc").toggle();
        if (_this.lrcScroller) setTimeout(function(){_this.lrcScroller.refresh();_this.isTouchingLrc = false;}, 300);
    },
